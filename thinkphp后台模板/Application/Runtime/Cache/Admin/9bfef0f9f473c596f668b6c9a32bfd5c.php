                ...
                <?php if(is_array($list)): foreach($list as $k=>$vo): ?><div class="ProList">
                        <ul>
                            ...
                            <li class="Name">
                                ...
                                <?php if($vo['ispart'] == 0): ?><a href="<?php echo U('Category/edit',array('catid'=>$vo['catid']));?>"><?php echo ($vo["catname"]); ?></a>
                                <?php else: ?>
                                    <?php echo ($vo["catname"]); endif; ?>
                            </li>
                            <li class="S_Order">
                            ...
                            <li class="Oper">
                            	<div>
                                    ...
                                    <span>|</span>
                                    <a  href="<?php echo U('Category/delete',array('catid'=>$vo['catid']));?>">删除</a>
                                </div>
                            </li>
                        </ul>
